...
$sql = "select * from canvas_border";
$result=mysqli_query($con,$sql);
	while(($row=mysqli_fetch_array($result)))
	{
	   // $image_name = $row['image_name'];
	    $border_json = $row['border_json'];
...
<div class="box">
    ...
    <!--<button onclick="loadJson2Canvas()" class="btn-xs btn-primary">Border</button>-->
</div>
...
<div class="box-left"> 
 <form method="post" accept-charset="utf-8" name="form1">
      ...
      <textarea id='canvas_details' name="canvas_details" style="display:none"><?php echo $border_json; ?></textarea>
    </form>
...
canvas.on("object:moving", function(e){
    ...
    obj.right = Math.min(Math.max(3, bound.right), height - bound.height);
})
