...
if(isset($_POST['create_template']) ) {
    ...
    // $str_concat = str_replace(["#name","#phone","#email","#address",$getbase643],[$replace_name = "Name : ".$name,$replace_phone = "Phone : ".$phone,$replace_email = "Email : ".$email,$replace_address = "Address : ".$adress,$base641], $canvas_details);   
...
<body>
  ...
  <div id="app">
    ...
    <form action ="" method = "POST" enctype="multipart/form-data">       
       <input type="text" name="user_name" class="<?php echo $hide_name; ?>" id = "user_name" placeholder="Name">
       <input type="text" name="user_phone" class="<?php echo $hide_phone; ?>" id = "user_phone" placeholder="Phone">
       <input type="text" name="user_email" class="<?php echo $hide_email; ?>" id = "user_email" placeholder="Email">
       <input type="text" name="user_address" class="<?php echo $hide_address; ?>" id = "user_phone" placeholder="Address">
       <input type="file" class="form-control" name="user_logo" accept=".jpg,.png,.jpeg,.JPG,.JPEG" required>
       <input type = "submit" class="btn-primary" Value = "Create" name="create_template">
    </form>
       </div>
       </br>
       
       <div class="row">
          <button onclick="Addtext()" class="btn-xs btn-primary">Add Texto</button>
...
<div class="box">
    ...
    <button onclick="loadJson2Canvas()" id ="loadJson2Canvas" class="btn-xs btn-primary">Add Texto</button>
</div>
...
<div class="box-left"> 
 <form method="post" accept-charset="utf-8" name="form1">
      <input name="hidden_data" id='hidden_data' type="text" value="<?php echo $image_name; ?>"/>
      
      <input name="id" id="id" type="hidden" value="150">
      <!--<input name="canvas_details" id='canvas_details' type="text"/>-->
      <textarea id='canvas_details' name="canvas_details"><?php echo $str_concat; ?></textarea>
    </form>
